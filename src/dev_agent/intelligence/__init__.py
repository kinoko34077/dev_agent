...
_LAZY_EXPORTS = {
    ...
    "PlanningConvergenceResult": (".planner_adapter", "PlanningConvergenceResult"),
    "PlanningResponseError": (".planner_adapter", "PlanningResponseError"),
    "propose_with_planning_convergence": (".planner_adapter", "propose_with_planning_convergence"),
    ...
    "ConvergenceAssessment": (".convergence", "ConvergenceAssessment"),
    "ConvergenceObservation": (".convergence", "ConvergenceObservation"),
    ...
    "ValidationRung": (".convergence", "ValidationRung"),
    "assess_convergence": (".convergence", "assess_convergence"),
