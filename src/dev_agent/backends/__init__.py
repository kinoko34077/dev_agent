...
_LAZY_EXPORTS = {
    ...
    "AgentBackendArtifactReference": (".protocol", "AgentBackendArtifactReference"),
    ...
    "AgentBackendDiscoveryReceipt": (".dispatcher", "AgentBackendDiscoveryReceipt"),
    "AgentBackendDiscoveryRequest": (".dispatcher", "AgentBackendDiscoveryRequest"),
    "AgentBackendDispatcher": (".dispatcher", "AgentBackendDispatcher"),
    "BackendAdmission": (".dispatcher", "BackendAdmission"),
    "BackendDiscoveryAuthority": (".dispatcher", "BackendDiscoveryAuthority"),
