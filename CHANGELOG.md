...
- 現行 `v2/bootstrap` のローカル全テストは `238 passed`。外部GitHub Actionsも `2319a21` に対して `v2-core` run `34306108062` / `v2 tests` run `34306108041` がともにsuccess（各runの `GITHUB_SHA` は対象commitと一致）。
