...
- 現行 `v2/bootstrap` のローカル全テストは `237 passed`。外部GitHub Actionsも `8b423e3` に対して `v2-core` run `34304428374` / `v2 tests` run `34304428429` がともにsuccess（各runの `GITHUB_SHA` は対象commitと一致）。
