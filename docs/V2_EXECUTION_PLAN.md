...
| **Next Development Target**（次に着手する開発） | Group Dの次slice（structured evidenceのdurable artifact化、bounded artifact extraction、discover/resume/reconciliation設計）を小さく分割して進める。MCP Adapter、OS Sandbox、Evidence routing接続、Workflow Promotionはその後の別Gate |
