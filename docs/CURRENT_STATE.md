...
| --- | --- |
| Branch | `v2/bootstrap` |
| Implementation/evidence baseline | `32e6495` (D9 repair-candidate materializer bound to the public Supervisor/manifest boundary) |
| Worktree | clean after D9 live Worker candidate evidence sync |
| Local regression | `1058 passed, 1 skipped` (`python -m pytest tests/v2 -q`, 278.81s) |
