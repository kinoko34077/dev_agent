...
| --- | --- |
| Branch | `v2/bootstrap` |
| Implementation/evidence baseline | `a2734f8` (D9 approval-bound Host adapter with deterministic temporary-Git integration regression) |
| Worktree | clean after D9 Host adapter integration regression |
| Local regression | `1058 passed, 1 skipped` (`python -m pytest tests/v2 -q`, 203.71s) |
| Architecture | `ARCHITECTURE_PASS` |
| Compile | `python -m compileall -q src recovery scripts` PASS |
| Exact-head CI | PASS for current implementation/evidence HEAD `a2734f89c2483c35eb82573339cb6ff93cde07e0`: `v2-core` [run 34816700314](https://github.com/kinoko34077/dev_agent/actions/runs/34816700314) and `v2-provider-smoke` [run 34816700242](https://github.com/kinoko34077/dev_agent/actions/runs/34816700242). |
