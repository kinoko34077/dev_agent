...
| --- | --- |
| Branch | `v2/bootstrap` |
| Implementation/evidence baseline | `c9789b2fe7b93586f422d59e17826fb246f64cc0` |
...
1. Keep the planner pool/failover implementation and exact-head CI evidence current; the current implementation/evidence baseline is `c9789b2`.
2. Obtain an explicitly approved external-send boundary for the D1 planning objective/repository context, then perform one bounded pool-routed live observation.
