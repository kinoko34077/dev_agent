...
| --- | --- |
| Branch | `v2/bootstrap` |
| Current HEAD | `f072726` (`docs: align current state with verified head`) |
...
| Exact-head CI | PASS for current HEAD `f07272618efa618e34abe6c17c3b39d651ded144`: `v2-core` [run 34839191946](https://github.com/kinoko34077/dev_agent/actions/runs/34839191946) and `v2-provider-smoke` [run 34839191929](https://github.com/kinoko34077/dev_agent/actions/runs/34839191929). |
