...
code evidence baseline is `ec39e8bc3ce2e46a741c7a96599f1122db30407a`. External
CI runs for that revision passed: `v2-core` run `34308323345` and `v2 tests` run
`34308323266`. Phase 6 is
